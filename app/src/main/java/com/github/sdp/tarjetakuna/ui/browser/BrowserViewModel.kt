    ...
    private fun generateCards(): ArrayList<MagicCard> {
        ...
        for (i in 0..39) {
            ...
            val card = MagicCard(
                ...
                2,
                "{1}{W}",
                MagicSet("BRO", name, "Core", LocalDate.of(2019, 3, 10), "https://svgs.scryfall.io/sets/bro.svg?1682913600", 388, "", "cards"),
                1,
                "https://cards.scryfall.io/normal/front/9/1/9102e1aa-7123-4c16-a810-d65b4505e147.jpg?1681084669",
                MagicRarity.RARE,
        ...
        cardsArray.add(
            MagicCard(
                ...
                3,
                "{1}{W}{W}",
                MagicSet("BRO", "The Brothers' War", "expansion", LocalDate.parse("2022-11-18"), "https://svgs.scryfall.io/sets/bro.svg?1682913600", 388, "", "cards"),
                1,
                "https://cards.scryfall.io/normal/front/9/1/9102e1aa-7123-4c16-a810-d65b4505e147.jpg?1681084669",
                MagicRarity.COMMON,
                MagicCardType.CREATURE,
